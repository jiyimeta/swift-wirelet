...
final class WireletObservableMacroDiagnosticsTests: XCTestCase {
    ...
    func testUnsupportedExposedMethodSignatureRaisesDiagnostic() {
        assertMacroExpansion(
            ...
            public func __Multi_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
...
final class WireletObservablePrimitiveExpansionTests: XCTestCase {
    func testInt32AndBoolStoredProperties() {
        assertMacroExpansion(
            ...
            public func __CounterVM_count_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jint {
            ...
            public func __CounterVM_active_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jboolean {
            ...
            public func __CounterVM_new_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?
            ) -> jlong {
            ...
            public func __CounterVM_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
            ...
            public func __CounterVM_count_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jint
            ) {
            ...
            public func __CounterVM_active_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
...
final class WireletObservableCompositeExpansionTests: XCTestCase {
    func testWireFormatStructProperty() {
        assertMacroExpansion(
            ...
            public func __ItemVM_item_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jbyteArray? {
            ...
            public func __ItemVM_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
            ...
            public func __ItemVM_item_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
    ...
    func testWireFormatArrayProperty() {
        assertMacroExpansion(
            ...
            public func __ItemsVM_items_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jbyteArray? {
            ...
            public func __ItemsVM_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
            ...
            public func __ItemsVM_items_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jbyteArray?
            ) {
    ...
    func testOptionalStringProperty() {
        assertMacroExpansion(
            ...
            public func __MaybeVM_maybe_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jstring? {
            ...
            public func __MaybeVM_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
            ...
            public func __MaybeVM_maybe_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jstring?
            ) {
...
// MARK: - Task 13: Golden snapshot — TodoListVM design-doc example

final class WireletObservableGoldenTests: XCTestCase {
    func testTodoListVMMatchesDesignDoc() {
        assertMacroExpansion(
            """
            @WireletObservable
            @Observable
            ...
            public func __TodoListVM_items_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jbyteArray? {
            ...
            public func __TodoListVM_filter_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jstring? {
                ...
                let me = WireletObservableJNI.unwrap(self_ptr) as TodoListVM
                let runnable = JObject(env: env, jobject: on_change)
                let snapshot = ObservationTrackingHelper.read(\\.filter, on: me) {
                    runnable?.call(method: "run")
                }
            ...
            public func __TodoListVM_totalCount_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jint {
                let me = WireletObservableJNI.unwrap(self_ptr) as TodoListVM
                let runnable = JObject(env: env, jobject: on_change)
                let snapshot = ObservationTrackingHelper.read(\\.totalCount, on: me) {
                    runnable?.call(method: "run")
                }
                return jint(snapshot)
            }
            ...
            public func __TodoListVM_new_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?
            ) -> jlong {
            ...
            public func __TodoListVM_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
            ...
            public func __TodoListVM_items_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jbyteArray?
            ) {
            ...
            @_cdecl("WireletObservable_TodoListVM_filter_set")
            public func __TodoListVM_filter_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jstring?
            ) {
                ...
                let me = WireletObservableJNI.unwrap(self_ptr) as TodoListVM
                me.filter = String(cString: cstr)
            }

            @_cdecl("WireletObservable_TodoListVM_totalCount_set")
            public func __TodoListVM_totalCount_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jint
            ) {
                let me = WireletObservableJNI.unwrap(self_ptr) as TodoListVM
                me.totalCount = Int32(new_value)
            }

            @_cdecl("WireletObservable_TodoListVM_add_invoke")
            public func __TodoListVM_add_invoke_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ arg0: jbyteArray?
            ) {
            ...
            @_cdecl("WireletObservable_TodoListVM_clear_invoke")
            public func __TodoListVM_clear_invoke_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
                let me = WireletObservableJNI.unwrap(self_ptr) as TodoListVM
...
final class WireletObservableConstructorAndInvokeTests: XCTestCase {
    ...
    func testNewReleaseAndStringSetter() {
        assertMacroExpansion(
            ...
            public func __LabelVM_label_track_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ on_change: jobject?
            ) -> jstring? {
            ...
            public func __LabelVM_release_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong
            ) {
            ...
            public func __LabelVM_label_set_jni(
                _ env: UnsafeMutablePointer<JNIEnv?>?,
                _ self_ptr: jlong,
                _ new_value: jstring?
            ) {
